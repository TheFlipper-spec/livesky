...
const el = {
  ...
  effectsSelect: $('effects-select'), installItem: $('install-item'), installGroup: $('install-group'),
  offlineBanner: $('offline-banner'),
  menuClose: $('menu-close'), menuBackdrop: $('menu-backdrop'), spGrab: $('sp-grab'), spBody: $('sp-body'),
  installPrompt: $('install-prompt'), installClose: $('install-close'), installCta: $('install-cta'),
  installLater: $('install-later'), installSteps: $('install-steps'),
